...
<div class="tinv-wishlist woocommerce">
	...
	<p class="cart-empty woocommerce-info">
		<?php if ( get_current_user_id() === $wishlist['author'] ) { ?>
			<?php esc_html_e( 'Your Wishlist is currently empty.', 'ti-woocommerce-wishlist-premium' ); ?>
		<?php } else { ?>
			<?php esc_html_e( 'Wishlist is currently empty.', 'ti-woocommerce-wishlist-premium' ); ?>
		<?php } ?>
	</p>
